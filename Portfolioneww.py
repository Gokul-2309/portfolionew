...
background: radial-gradient(circle at 10% 20%, #1e3a8a 0%, transparent 40%),
            ...
            radial-gradient(circle at 50% 50%, #0f172a 20%, #020617 100%);
color:#E2E8F0;
}
...
box-shadow:0px 8px 20px rgba(34,211,238,0.5);
}
...
transform:translateY(-4px);
box-shadow:0px 8px 20px rgba(34,211,238,0.6);
}
...
box-shadow:0px 6px 18px rgba(34,211,238,0.5);
}
...
box-shadow:0px 12px 35px rgba(34,211,238,0.4);
}
