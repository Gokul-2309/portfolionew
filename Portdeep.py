...
with st.sidebar:
    ...
    selected = option_menu(
        ...
        options=["Home", "Projects", "Skills", "Experience", "Contact", "Chat with Me"],
        icons=["house", "code-square", "gear", "briefcase", "envelope", "chat-dots"],
        menu_icon="cast",
        default_index=0,
        styles={
            "container": {"padding": "0!important", "background-color": "rgba(255,255,255,0.1)"},
            "icon": {"color": "#00f7ff", "font-size": "20px"},
            "nav-link": {"font-size": "16px", "text-align": "left", "margin": "0px", "color": "white"},
            "nav-link-selected": {"background-color": "#00f7ff", "color": "black"},
        }
    )
...
if selected == "Home":
    ...
    with col2:
        # Display profile image from file or placeholder
        try:
            st.markdown("""
            <div style='text-align: center; padding: 20px;'>
                <img src='data:image/jpeg;base64,{}' class='profile-img'>
            </div>
            """.format(base64.b64encode(open("profile.jpg", "rb").read()).decode()), 
            unsafe_allow_html=True)
        except:
            st.markdown("""
            <div style='text-align: center; padding: 20px;'>
    ...
    <div style='text-align: center; padding: 20px;'>
        ...
        <div style='font-size: 24px; color: white; min-height: 60px;'>
            <span id="typing"></span>
        </div>
    </div>
...
# ----------- PROJECTS SECTION -----------
    ...
    # GitHub API integration for auto-loading repos
        ...
        with col1 if i % 2 == 0 else col2:
            ...
            <div class='project-card'>
                ...
                <div style='margin-top: 15px;'>
                    <a href='{project['github']}' target='_blank' class='custom-button' style='margin-right:10px;'>GitHub</a>
    ...
    if repos:
        for repo in repos[:6]:  # Show first 6 repos
            st.markdown(f"""
            <div class='project-card' style='margin:10px 0;'>
                ...
                <a href='{repo['html_url']}' target='_blank' class='custom-button' style='margin-top:10px;'>View on GitHub</a>
            </div>
            """, unsafe_allow_html=True)
    else:
...
# ----------- SKILLS SECTION -----------
    ...
    for skill, level in skills_data.items():
        ...
        <div style='margin: 20px 0;'>
            ...
            <div class='skill-container'>
                <div class='skill-bar' style='--width:{level}%; width:{level}%;'>
                    {'★' * (level//20)} {'☆' * (5 - level//20)}
                </div>
            </div>
        </div>
    ...
    for i, skill in enumerate(additional_skills):
        cols[i % 3].markdown(f"""
        <div style='text-align:center; padding:10px; margin:5px; background:rgba(255,255,255,0.1); border-radius:10px;'>
            <span style='color:#00f7ff;'>{skill}</span>
        </div>
        """, unsafe_allow_html=True)
    ...
    for exp in timeline_data:
        ...
        <div class='project-card' style='margin:20px 0;'>
            <div style='display:flex; justify-content:space-between;'>
                ...
                <span style='color:#00f7ff;'>{exp['date']}</span>
            </div>
...
# ----------- CONTACT SECTION -----------
    ...
    with col1:
        ...
        <div class='project-card'>
            ...
            <p style='margin:20px 0;'>📧 gokulms2309@gmail.com</p>
            <p>📍 Chennai, India</p>
            <p>📞 +91 9566260923</p>
...
# ----------- CHATBOT SECTION -----------
    ...
    <div class='chat-container'>
        <p style='color:#00f7ff;'>Ask me anything about Gokul's skills, experience, or projects!</p>
    </div>
    """, unsafe_allow_html=True)
...
def generate_chat_response(prompt):
    ...
    responses = {
        "skills": "Gokul is proficient in Python, MySQL, Flask, Data Analysis, Machine Learning, Tableau, and Excel. He has a 95% proficiency in Python and 92% in Data Analysis!",
        "experience": "Gokul completed a 6-month internship as a Software Developer at Expert Medical Billing, where he developed a Client Portal Dashboard. He's currently pursuing a Python Developer course.",
        "projects": "Gokul has built several projects including a Client Portal Dashboard, Lung Cancer Prediction model, Data Visualization Dashboard, and E-commerce Analytics platform.",
        "contact": "You can reach Gokul at gokulms2309@gmail.com or connect with him on LinkedIn and GitHub!",
        "education": "Gokul is currently enrolled in a Python Developer Course covering Python, MySQL, and Flask development.",
        "github": "You can find Gokul's projects on GitHub at github.com/yourgithub. He has several repositories showcasing his work in data analysis and web development!"
    }
